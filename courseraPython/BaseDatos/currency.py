...
#DESCOMENTAR PARA PROBAR INSERCION
# peso_arg = Currency(code='ARS', name='Pesos (ARG)', symbol='$')
# dolar = Currency(code='USD', name='Dolar', symbol='US$')
...
#DESCOMENTAR PARA PROBAR BUSQUEDA
...
#DESCOMENTAR PARA PROBAR UPDATE
...
#PROBANDO EL BORRADO DE OBJETOS
